...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Hidden real inputs */
        #deadline-hidden, #prioritas-hidden { display: none; }
...
<body>
    ...
    <div class="page-title">TAMBAH TUGAS</div>

    <form action="{{ route('tasks.store') }}" method="POST" id="create-form">
        @csrf

        <!-- Hidden actual inputs -->
        <input type="hidden" name="deadline" id="deadline-hidden">
        <input type="hidden" name="prioritas" id="prioritas-hidden">
        ...
        <div class="form-card">
            ...
            <div class="field-box clickable" onclick="openDatePicker()">
                ...
                <div class="field-hint" id="deadline-display">Klik kalender untuk menentukan deadline</div>
            </div>
            ...
            <div class="diff-dropdown">
                <div class="field-box clickable" onclick="toggleDiff()">
                    ...
                    <div class="field-hint" id="diff-display">Pilih tingkat kesulitan</div>
                </div>
    ...
    <script>
        ...
        // ── DATE PICKER ──
        const now = new Date();
        let dpYear = now.getFullYear(), dpMonth = now.getMonth(), dpDay = now.getDate();
        ...
        document.getElementById('create-form').addEventListener('submit', function(e) {
            if (!document.getElementById('deadline-hidden').value) {
                e.preventDefault(); alert('Silakan pilih deadline terlebih dahulu.'); return;
            }
            if (!document.getElementById('prioritas-hidden').value) {
                e.preventDefault(); alert('Silakan pilih tingkat kesulitan terlebih dahulu.'); return;
            }
        });
    </script>
